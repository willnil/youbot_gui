...
def callback(msg):
	...
	try:
		image_message = bridge.cv2_to_imgmsg(edges,encoding="mono8")
	except CvBridgeError as e:
		print(e)
...
if __name__ == '__main__':
	...
	rate = rospy.Rate(0.5) #go through the loop 1 time every 2 seconds

	while not rospy.is_shutdown():
		#subscriber to topic from cv_camera 
		rospy.Subscriber('/cv_camera/image_raw',Image,callback)
		#publisher  
		pub = rospy.Publisher('/canny_edge_detector/image_canny',Image,queue_size=1)	
		rate.sleep()
